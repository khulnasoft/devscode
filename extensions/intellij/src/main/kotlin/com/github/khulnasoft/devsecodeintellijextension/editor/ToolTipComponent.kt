import com.github.khulnasoft.devscodeintellijextension.actions.focusDevscodeInput
import com.github.khulnasoft.devscodeintellijextension.editor.openInlineEdit
...
class ToolTipComponent(editor: Editor, x: Int, y: Int) :
    ...
    init {
        ...
        addToChatButton.addActionListener { e: ActionEvent? ->
            focusDevscodeInput(editor.project)
