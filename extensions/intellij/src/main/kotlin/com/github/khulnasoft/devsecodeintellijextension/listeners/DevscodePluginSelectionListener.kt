package com.github.khulnasoft.devscodeintellijextension.listeners

import ToolTipComponent
import com.github.khulnasoft.devscodeintellijextension.editor.EditorUtils
import com.github.khulnasoft.devscodeintellijextension.services.DevscodeExtensionSettings
import com.github.khulnasoft.devscodeintellijextension.utils.Debouncer
...
class DevscodePluginSelectionListener(
    ...
    private fun shouldRemoveTooltip(selectedText: String?, editor: Editor): Boolean {
        return selectedText.isNullOrEmpty() ||
                !service<DevscodeExtensionSettings>().devscodeState.displayEditorTooltip
    }
