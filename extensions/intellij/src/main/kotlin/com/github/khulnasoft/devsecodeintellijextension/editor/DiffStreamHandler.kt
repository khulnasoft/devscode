...
class DiffStreamHandler(
    ...
    private val curLineKey = createTextAttributesKey("DEVSCODE_DIFF_CURRENT_LINE", 0x40888888, editor)
    private val unfinishedKey = createTextAttributesKey("DEVSCODE_DIFF_UNFINISHED_LINE", 0x20888888, editor)
    ...
    fun streamDiffLinesToEditor(
        ...
        val devscodePluginService = ServiceManager.getService(project, DevscodePluginService::class.java)
