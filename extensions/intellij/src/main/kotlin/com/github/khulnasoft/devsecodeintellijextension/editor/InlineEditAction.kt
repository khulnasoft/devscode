package com.github.khulnasoft.devscodeintellijextension.editor

import com.github.khulnasoft.devscodeintellijextension.`devscode`.GetTheme
...
import com.github.khulnasoft.devscodeintellijextension.utils.getMetaKeyLabel
...
fun openInlineEdit(project: Project?, editor: Editor) {
    ...
    val devscodePluginService = project.service<DevscodePluginService>()
    val modelTitles = mutableListOf<String>()
    devscodePluginService.coreMessenger?.request("config/getSerializedProfileInfo", null, null) { response ->
    ...
    // check.
    // the highlighted range will devscode to the following line.
        ...
        JPanel(MigLayout("insets 0, fillx")).apply {
            ...
            val dropdown =
                JComboBox(modelTitles.toTypedArray()).apply {
                    ...
                    selectedIndex =
                        if(itemCount == 0) -1 else devscodeSettingsService.devscodeState.lastSelectedInlineEditModel?.let {
                    ...
                    addActionListener {
                        devscodeSettingsService.devscodeState.lastSelectedInlineEditModel =
