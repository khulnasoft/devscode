...
export const DIFF_DIRECTORY = path
  .join(os.homedir(), ".devscode", ".diffs")
  .replace(/^C:/, "c:");

export class DiffManager {
  // Create a temporary file in the global .devscode directory which displays the updated version
  ...
  private remoteTmpDir = "/tmp/devscode";
