...
export class DevscodeGUIWebviewViewProvider
  implements vscode.WebviewViewProvider
{
  public static readonly viewType = "devscode.devscodeGUIView";
  ...
  private setupDebugLogsListener() {
    vscode.workspace.onDidChangeConfiguration((event) => {
      if (event.affectsConfiguration("devscode.enableDebugLogs")) {
        const settings = vscode.workspace.getConfiguration(EXTENSION_NAME);
  ...
  constructor(
    ...
    this.outputChannel = vscode.window.createOutputChannel("Devscode");
