...
## Try asking Devscode "what sorting algorithm is this?"
...
## Try asking Devscode to "make this more readable"
def sorting_algorithm(x):
    for i in range(len(x)):
        for j in range(len(x) - 1):
            if x[j] > x[j + 1]:
...
# ——————————————————      Learn more at https://docs.devscode.dev/getting-started/overview      ——————————————————— #
