...
import DevscodeButton from "../components/mainInput/DevscodeButton";
...
function MigrationPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p>
        Devscode now uses a .json config file. We hope that this takes the
      ...
      <p>
        ...
        please see the{" "}
        <a
          href="https://docs.devscode.dev/walkthroughs/config-file-migration"
          target="_blank"
        >
