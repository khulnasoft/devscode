      ...
      <div className="gap-2 divide-x-0 divide-y-2 divide-solid divide-zinc-700 px-4">
        ...
        <div className="py-5">
          ...
          <div className="flex flex-col gap-5">
            <MoreHelpRow
              title="Documentation"
              description="Learn how to configure and use Devscode"
              Icon={ArrowTopRightOnSquareIcon}
              onClick={() =>
                ideMessenger.post("openUrl", "https://docs.devscode.dev/")
              }
            />
            ...
            <MoreHelpRow
              ...
              onClick={() =>
                ideMessenger.post(
                  "openUrl",
                  "https://github.com/khulnasoft/devscode/issues/new/choose",
                )
              }
            />
