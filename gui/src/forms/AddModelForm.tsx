...
const MODEL_PROVIDERS_URL =
  "https://docs.devscode.dev/customize/model-providers";
const CODESTRAL_URL = "https://console.mistral.ai/codestral";
const DEVSCODE_SETUP_URL = "https://docs.devscode.dev/setup/overview";
        ...
        <div className="mx-auto max-w-md p-6">
          ...
          {!hideFreeTrialLimitMessage && hasPassedFTL() && (
            <p className="text-sm text-gray-400">
              ...
              free inputs. To keep using Devscode, you can either use your own
              API key, or use a local LLM. To read more about the options, see
              our{" "}
              <a
                onClick={() => ideMessenger.post("openUrl", DEVSCODE_SETUP_URL)}
              >
                documentation
              </a>
              .
