...
const GITHUB_AUTH_URL =
  "https://github.com/settings/tokens/new?scopes=user:email&description=Devscode%20Free%20Trial%20Token%20";
  ...
  return (
    <div className="flex flex-col gap-3 p-8">
      <div className="text-center">
        ...
        <p className="text-sm">
          Devscode will request read access to your GitHub email so that we can
          prevent abuse of the free trial. If you prefer not to sign in, you can
          use Devscode with your own API keys or local model.
        </p>
      </div>
