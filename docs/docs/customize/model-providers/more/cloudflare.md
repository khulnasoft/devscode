...
Cloudflare Workers AI can be used for both chat and tab autocompletion in Devscode. To setup Cloudflare Workers AI, add the following to your `config.json` file:
...
[View the source](https://github.com/khulnasoft/devscode/blob/main/core/llm/llms/Cloudflare.ts)
