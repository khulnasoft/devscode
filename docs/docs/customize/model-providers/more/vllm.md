...
The devscode implementation uses [OpenAI](../top-level/openai.md) under the hood and automatically selects the available model. You only need to set the `apiBase` like this:
...
[View the source](https://github.com/khulnasoft/devscode/blob/main/core/llm/llms/Vllm.ts)
