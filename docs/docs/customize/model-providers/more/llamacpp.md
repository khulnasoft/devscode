...
After it's up and running, change `~/.devscode/config.json` to look like this:
...
[View the source](https://github.com/khulnasoft/devscode/blob/main/core/llm/llms/LlamaCpp.ts)
