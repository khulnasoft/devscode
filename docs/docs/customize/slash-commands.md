  ...
  "slashCommands": [
    {
      ...
      "params": { "outputDir": "~/.devscode/session-transcripts" }
    }
  ]
}
```
...
Write a custom slash command at your own HTTP endpoint. Set 'url' in the params object for the endpoint you have setup. The endpoint should return a sequence of string updates, which will be streamed to the Devscode sidebar. See our basic [FastAPI example](https://github.com/khulnasoft/devscode/blob/74002369a5e435735b83278fb965e004ae38a97d/core/context/providers/context_provider_server.py#L34-L45) for reference.
...
Describe the issue you'd like to generate, and Devscode will turn into a well-formatted title and body, then give you a link to the draft so you can submit. Make sure to set the URL of the repository you want to generate issues for.
  ...
  "slashCommands": [
    {
      ...
      "params": { "repositoryUrl": "https://github.com/khulnasoft/devscode" }
    }
  ]
}
```
...
The [Model Context Protocol](https://modelcontextprotocol.io/introduction) is a standard proposed by Anthropic to unify prompts, context, and tool use. Devscode supports MCP "prompts" by creating slash commands. Read their [quickstart](https://modelcontextprotocol.io/quickstart) to learn how to set up a local server and then configure your `config.json` like this:
