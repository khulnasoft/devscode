...
As explained on the [context selection](context-selection.md) page, Devscode uses a number of retrieval methods to find relevant snippets from your codebase to include in the prompt.
