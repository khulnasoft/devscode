...
const config = {
  ...
  projectName: "devscode", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/khulnasoft/devscode/tree/main/docs",
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: "https://docs.devscode.dev/img/devscode-social-card.png",
      navbar: {
        title: "Devscode",
        logo: {
          alt: "Devscode Logo",
          src: "img/logo.png",
          href: "https://devscode.dev",
          target: "_blank",
        },
        items: [
          {
          ...
          {
            to: "https://github.com/khulnasoft/devscode",
            label: "GitHub",
            position: "right",
        ...
        links: [
          {
            ...
            items: [
              {
                label: "VS Code",
                to: "https://marketplace.visualstudio.com/items?itemName=Devscode.devscode",
              },
              {
                label: "JetBrains",
                to: "https://plugins.jetbrains.com/plugin/22707-devscode-extension",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              {
                label: "Twitter",
                to: "https://twitter.com/khulnasoft",
              },
              {
                label: "LinkedIn",
                to: "https://linkedin.com/company/khulnasoft",
              },
            ],
          },
        ],
    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          {
            to: "/customize/tutorials/running-devscode-without-internet",
            from: "/walkthroughs/running-devscode-without-internet",
          },
          {
