...
export const EXTENSION_NAME = "devscode";
...
const WORKOS_ENV_ID_PRODUCTION = "devscode";
const WORKOS_ENV_ID_STAGING = "devscode-staging";
...
const PRODUCTION_ENV: ControlPlaneEnv = {
  ...
  APP_URL: "https://app.devscode.dev",
};
...
const STAGING_ENV: ControlPlaneEnv = {
  ...
  APP_URL: "https://app-preview.devscode.dev",
};
