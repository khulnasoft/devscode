...
export default class DocsService {
  ...
  private async handleConfigUpdate({
    ...
    config: DevscodeConfig | undefined;
  }) {
    if (newConfig) {
  ...
  private async syncOrReindexAllDocs(
    newConfig: DevscodeConfig,
    oldConfig?: DevscodeConfig,
  ) {
  ...
  */
  private async syncDocsOnConfigUpdate(
    oldConfig: DevscodeConfig | undefined,
    newConfig: DevscodeConfig,
  ) {
    try {
      this.isSyncing = true;
