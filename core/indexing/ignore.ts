...
import { getGlobalDevscodeIgnorePath } from "../util/paths";
...
export const getGlobalDevscodeIgArray = () => {
  const contents = fs.readFileSync(getGlobalDevscodeIgnorePath(), "utf8");
