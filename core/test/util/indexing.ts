...
import { IDevscodeServerClient } from "../../devscodeServer/interface";
...
export const testDevscodeServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IDevscodeServerClient;

const mockDevscodeServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IDevscodeServerClient;
