...
# It is used to define and reuse prompts within Devscode
# Devscode will automatically create a slash command for each prompt in the .prompts folder
# To learn more, see the full .prompt file reference: https://docs.devscode.dev/features/prompt-files
temperature: 0.0
---
{{{ diff }}}
