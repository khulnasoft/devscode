...
export type ToCoreFromIdeOrWebviewProtocol = {
  ...
  "config/addModel": [
    {
      model: SerializedDevscodeConfig["models"][number];
  ...
  "config/getSerializedProfileInfo": [
    undefined,
    { config: BrowserSerializedDevscodeConfig; profileId: string },
  ];
  "config/deleteModel": [{ title: string }, void];
  "config/reload": [undefined, BrowserSerializedDevscodeConfig];
