...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  focusDevscodeInput: [undefined, void];
  focusDevscodeInputWithoutClear: [undefined, void];
  focusDevscodeInputWithNewSession: [undefined, void];
  highlightedCode: [
    {
  ...
  focusDevscodeSessionId: [{ sessionId: string | undefined }, void];
